...
public class US_10_TermsAndConditions extends TestBaseRapor {
    ...
    public void TC12() {
        ...
        // Sayfanin en altina inilir ve 'Terms and Conditions' yazisinin oldugu test edilir
        ...
        String actualText = userHomepage.footerTermsAndConditions.getText();
        ...
        userHomepage.footerTermsAndConditions.click();
        String expectedTitle = "TERMS AND CONDITIONS";
        String actualTitle = userHomepage.termsAndConditionsTitle.getText();
